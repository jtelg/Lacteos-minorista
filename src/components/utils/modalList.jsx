  ...
  return (
    <>
      <section
        ...
        }  w-full fixed left-0 min-h-full top-0 overflow-hidden transition-all z-[100] flex  items-center justify-center`}
      >
        <div
          className="h-full w-full absolute top-0 left-0 bg-[#0000008f]"
          ...
          <div className="bg-white w-full rounded">
            ...
            <ul className="flex flex-col">
              {props.data.map((item, index) => (
                <li
                  key={index}
                  className={`cursor-pointer flex items-center border-b border-gray-100  px-2 py-3 justify-between hover:bg-gray transition-all
                  ${
